...
HD_PWD='E:/electronic/vivado/exp7/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source comb_test.tcl -notrace
