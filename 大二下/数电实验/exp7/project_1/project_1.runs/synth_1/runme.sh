...
HD_PWD='E:/electronic/vivado/exp7/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log comb_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source comb_test.tcl
