...
HD_PWD='E:/electronic/vivado/exp7/project_4/project_4.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log float_light.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source float_light.tcl
