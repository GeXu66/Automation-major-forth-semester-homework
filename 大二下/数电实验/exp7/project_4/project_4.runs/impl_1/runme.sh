...
HD_PWD='E:/electronic/vivado/exp7/project_4/project_4.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log float_light.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source float_light.tcl -notrace
